// Create a new file: src/translations/bookingTranslations.js
export const translations = {
    en: {
      ...
      heroSnapshot: "At a glance",
      newBooking: "Add Booking",
      upcomingHighlight: "Upcoming arrivals",
      pastHighlight: "Recent departures",
      viewAll: "View all",
      ...
      primaryResidence: "Villa",
      atAGlance: "At a glance",
      quickInsights: "Fast overview of arrivals and departures.",
      more: "more",
    ...
    ro: {
      ...
      heroSnapshot: "Privire rapidă",
      newBooking: "Adaugă rezervare",
      upcomingHighlight: "Sosiri viitoare",
      pastHighlight: "Plecări recente",
      viewAll: "Vezi tot",
      ...
      primaryResidence: "Vilă",
      atAGlance: "Pe scurt",
      quickInsights: "Privire rapidă asupra sosirilor și plecărilor.",
      more: "mai multe",
